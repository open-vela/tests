...
int media_utils_uvfocus2_test06_init(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
int media_utils_uvfocus2_test06_third(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
void test_media_uvfocus2_06(FAR void **state)
{
  ...
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test06_init, priv);
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test06_third, priv);
