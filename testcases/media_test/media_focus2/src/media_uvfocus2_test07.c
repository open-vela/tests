...
int media_utils_uvfocus2_test07_init(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
int media_utils_uvfocus2_test07_third(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
void test_media_uvfocus2_07(FAR void **state)
{
  ...
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test07_init, priv);
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test07_third, priv);
