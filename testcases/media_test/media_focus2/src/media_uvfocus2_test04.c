...
int media_utils_uvfocus2_test04_init(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
int media_utils_uvfocus2_test04_third(uvfocus2_priv_s *priv)
{
  // int ret = 0;
...
/*Interrupt + reply   A: auto reply B: hand reply*/
void test_media_uvfocus2_04(FAR void **state)
{
  ...
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test04_init, priv);
  UV_FOCUS2_EXECUTE(media_utils_uvfocus2_test04_third, priv);
