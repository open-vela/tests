/****************************************************************************
 * apps/tests/testcases/media_test/media_graph/media_graph_seek_and_position.c
 *
 * Name: media_graph_seek_and_position
 * Example description:
 *  1. media_graph_seek_and_position
 *
 ****************************************************************************/
...
int main(int argc, FAR char *argv[])
{
  ...
  syslog(LOG_INFO, "seek %d, after seek\n", media->position);
  FUN_CHECK(mediatest_position(media), media, mediatest_common_close, 0,
            "FAIL! get position fail.\n");
  sleep(3);
  ...
  syslog(LOG_INFO, "PASS ! media_graph_position pass \n");
  return 0;
}
