 ...
 *      Test suite file     : suites/test_suite_constant_time.function
 *      Test suite data     : suites/test_suite_constant_time.data
 *
 */
...
#line 2 "suites/test_suite_constant_time.function"
...
#line 19 "suites/test_suite_constant_time.function"
...
#line 29 "suites/test_suite_constant_time.function"
...
static void test_mbedtls_ct_memcmp_wrapper( void ** params )
{
    ...
    test_mbedtls_ct_memcmp( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ) );
}
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_MAC)
#line 70 "suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcpy_if_eq(int eq, int size, int offset)
{
...
static void test_mbedtls_ct_memcpy_if_eq_wrapper( void ** params )
{

    test_mbedtls_ct_memcpy_if_eq( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ) );
}
#endif /* MBEDTLS_SSL_SOME_SUITES_USE_MAC */
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_TLS_CBC)
#if defined(MBEDTLS_TEST_HOOKS)
#line 121 "suites/test_suite_constant_time.function"
static void test_ssl_cf_memcpy_offset(int offset_min, int offset_max, int len)
{
...
static void test_ssl_cf_memcpy_offset_wrapper( void ** params )
{
