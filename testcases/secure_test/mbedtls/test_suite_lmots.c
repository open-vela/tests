 ...
 *      Test suite file     : suites/test_suite_lmots.function
 *      Test suite data     : suites/test_suite_lmots.data
 *
 */
...
#line 2 "suites/test_suite_lmots.function"
#include "lmots.h"
...
#line 31 "suites/test_suite_lmots.function"
...
static void test_lmots_sign_verify_test_wrapper( void ** params )
{
    ...
    test_lmots_sign_verify_test( &data0, &data2, *( (int *) params[4] ), &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#if defined(MBEDTLS_LMS_PRIVATE)
#line 55 "suites/test_suite_lmots.function"
...
static void test_lmots_sign_verify_null_msg_test_wrapper( void ** params )
{
    ...
    test_lmots_sign_verify_null_msg_test( &data0, *( (int *) params[2] ), &data3 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#line 78 "suites/test_suite_lmots.function"
...
static void test_lmots_verify_test_wrapper( void ** params )
{
    ...
    test_lmots_verify_test( &data0, &data2, &data4, *( (int *) params[6] ) );
}
#line 144 "suites/test_suite_lmots.function"
...
static void test_lmots_import_export_test_wrapper( void ** params )
{
    ...
    test_lmots_import_export_test( &data0, *( (int *) params[2] ) );
}
#if defined(MBEDTLS_LMS_PRIVATE)
#line 199 "suites/test_suite_lmots.function"
...
static void test_lmots_reuse_test_wrapper( void ** params )
{
    ...
    test_lmots_reuse_test( &data0, &data2, *( (int *) params[4] ), &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#if defined(MBEDTLS_TEST_HOOKS)
#if defined(MBEDTLS_LMS_PRIVATE)
#line 224 "suites/test_suite_lmots.function"
...
static void test_lmots_signature_leak_test_wrapper( void ** params )
{
    ...
    test_lmots_signature_leak_test( &data0, &data2, *( (int *) params[4] ), &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
