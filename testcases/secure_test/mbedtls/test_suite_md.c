...
#line 19 "suites/test_suite_md.function"
...
#endif /* MBEDTLS_MD_C */
#line 48 "suites/test_suite_md.function"
...
#line 122 "suites/test_suite_md.function"
...
#line 156 "suites/test_suite_md.function"
...
static void test_md_text_wrapper( void ** params )
{
    ...
    test_md_text( *( (int *) params[0] ), (char *) params[1], &data2 );
}
#line 178 "suites/test_suite_md.function"
...
static void test_md_hex_wrapper( void ** params )
{
    ...
    test_md_hex( *( (int *) params[0] ), &data1, &data3 );
}
#line 199 "suites/test_suite_md.function"
...
static void test_md_text_multi_wrapper( void ** params )
{
    ...
    test_md_text_multi( *( (int *) params[0] ), (char *) params[1], &data2 );
}
#line 250 "suites/test_suite_md.function"
...
static void test_md_hex_multi_wrapper( void ** params )
{
    ...
    test_md_hex_multi( *( (int *) params[0] ), &data1, &data3 );
}
#if defined(MBEDTLS_MD_C)
#line 297 "suites/test_suite_md.function"
...
static void test_mbedtls_md_hmac_wrapper( void ** params )
{
    ...
    test_mbedtls_md_hmac( *( (int *) params[0] ), *( (int *) params[1] ), &data2, &data4, &data6 );
}
#endif /* MBEDTLS_MD_C */
#if defined(MBEDTLS_MD_C)
#line 321 "suites/test_suite_md.function"
...
static void test_md_hmac_multi_wrapper( void ** params )
{
    ...
    test_md_hmac_multi( *( (int *) params[0] ), *( (int *) params[1] ), &data2, &data4, &data6 );
}
#endif /* MBEDTLS_MD_C */
#if defined(MBEDTLS_FS_IO)
#if defined(MBEDTLS_MD_C)
#line 367 "suites/test_suite_md.function"
...
static void test_mbedtls_md_file_wrapper( void ** params )
{
    ...
    test_mbedtls_md_file( *( (int *) params[0] ), (char *) params[1], &data2 );
}
#endif /* MBEDTLS_MD_C */
#endif /* MBEDTLS_FS_IO */
#line 388 "suites/test_suite_md.function"
...
static void test_md_psa_dynamic_dispatch_wrapper( void ** params )
{
    ...
    test_md_psa_dynamic_dispatch( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ) );
}
