...
#endif
#line 17 "suites/test_suite_ecdsa.function"
...
#line 49 "suites/test_suite_ecdsa.function"
...
#line 84 "suites/test_suite_ecdsa.function"
...
#line 200 "suites/test_suite_ecdsa.function"
...
static void test_ecdsa_det_test_vectors_wrapper( void ** params )
{
    ...
    test_ecdsa_det_test_vectors( *( (int *) params[0] ), (char *) params[1], *( (int *) params[2] ), &data3, (char *) params[5], (char *) params[6] );
}
#endif /* MBEDTLS_ECDSA_DETERMINISTIC */
#if defined(MBEDTLS_HAS_ALG_SHA_256_VIA_MD_IF_DETERMINISTIC)
#line 233 "suites/test_suite_ecdsa.function"
...
#endif /* MBEDTLS_HAS_ALG_SHA_256_VIA_MD_IF_DETERMINISTIC */
#if defined(MBEDTLS_HAS_ALG_SHA_256_VIA_MD_IF_DETERMINISTIC)
#line 295 "suites/test_suite_ecdsa.function"
...
#line 361 "suites/test_suite_ecdsa.function"
...
#if defined(MBEDTLS_ECP_RESTARTABLE)
#if defined(MBEDTLS_ECDSA_DETERMINISTIC)
#line 426 "suites/test_suite_ecdsa.function"
...
static void test_ecdsa_write_restart_wrapper( void ** params )
{
    ...
    test_ecdsa_write_restart( *( (int *) params[0] ), (char *) params[1], *( (int *) params[2] ), &data3, &data5, *( (int *) params[7] ), *( (int *) params[8] ), *( (int *) params[9] ) );
}
#endif /* MBEDTLS_ECDSA_DETERMINISTIC */
#endif /* MBEDTLS_ECP_RESTARTABLE */
#line 490 "suites/test_suite_ecdsa.function"
...
static void test_ecdsa_verify_wrapper( void ** params )
{
    ...
    test_ecdsa_verify( *( (int *) params[0] ), (char *) params[1], (char *) params[2], (char *) params[3], (char *) params[4], &data5, *( (int *) params[7] ) );
}
...
#if defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_HAS_ALG_SHA_256_VIA_MD_IF_DETERMINISTIC)
