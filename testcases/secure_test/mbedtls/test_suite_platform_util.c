 ...
 *      Test suite file     : suites/test_suite_platform_util.function
 *      Test suite data     : suites/test_suite_platform_util.data
 *
 */
...
#line 2 "suites/test_suite_platform_util.function"
#include "mbedtls/platform_util.h"
#line 6 "suites/test_suite_platform_util.function"
...
static void test_mbedtls_platform_zeroize_wrapper( void ** params )
{
    ...
    test_mbedtls_platform_zeroize( *( (int *) params[0] ), *( (int *) params[1] ) );
}
#line 44 "suites/test_suite_platform_util.function"
...
static void test_mbedtls_platform_zeroize_uninitialised_wrapper( void ** params )
{
    ...
    test_mbedtls_platform_zeroize_uninitialised( *( (int *) params[0] ), *( (int *) params[1] ) );
}
