...
int anim_physics_gravity_test(int argc, char *argv[])
{
    ...
    */
    anim_vector2f_t positions[] = {
        {9.81f, 9.81f},       // index = 0; 对角线重力，动画位于右下角
        {-9.81f, -9.81f},     // index = 1; 对角线重力，动画位于左上角
        {9.81f, -9.81f},      // index = 2; 对角线重力，动画位于右上角
        {-9.81f, 9.81f},      // index = 3; 对角线重力，动画位于左下角
        {0, 9.81f},         // index = 4; 标准地球重力竖直
        {0, -9.81f},        // index = 5; 标准地球重力反向竖直
        {9.81f, 0},         // index = 6; 水平重力
        {-9.81f, 0},        // index = 7; 水平重力反向
