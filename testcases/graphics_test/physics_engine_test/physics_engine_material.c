...
int anim_physics_material_test(int argc, char *agrv[])
{
    ...
    */
    anim_physics_material_t material[] = {//密度不能为负数，摩擦力理想状态下为0，
        {0.91f, 0.12f, 0.82f},       // index = 0; 密度为0.91，弹力为1.12，摩擦力为0.82 正常值
        {0.00f, 0.00f, 0.00f},     // index = 1; 密度：0.00，弹力：0.00，摩擦力为0.00 摩擦力为理想状态值 
        {9.81f, 9.81f, 9.81f},     // index = 2; 按照float的最大值9.81f
    };
    int index = -1;
    if (agrv[2] != NULL)
    {
