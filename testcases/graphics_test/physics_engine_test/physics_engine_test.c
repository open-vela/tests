...
static inline void init_lv_image_obj(void)
{
    ...
    // anim_distance_joint_t joint;
    // joint.
    // init_lvgl_image(&icon_nodes[0], NULL, create_week_shape, 45, 3.0, linear_v);
...
int anim_physics_engine_test(int argc, char *agrv[])
{
    ...
    // anim_vector2f_t l1, l2;
    // l1.x = 10.0f;
    // l1.y = 10.0f;
    // l2.x = 50.0f;
    // l2.y = 50.0f;
    // printf("physics_engine_test body_circle: %lld\n", body_circle);
    // printf("physics_engine_test body circle_2: %lld\n", body_circle2);
    // anim_joint_t joint_body;
    // joint_body.type = ANIM_JOINT_DISTANCE;
    // joint_body.body1 = body_circle;
    // joint_body.body2 = body_circle2;
    // joint_body.user_data = NULL;

    // static anim_distance_joint_t joint_data;
    // joint_data.base = joint_body;
    // joint_data.local_anchor1 = l1;
    // joint_data.local_anchor2 = l2;
    // joint_data.length = 50.0f;
    // joint_data.min_length = 40.0f;
    // joint_data.max_length = 60.0f;
    // joint_data.damping = 1.0f;
    // joint_data.stiffness = 1.0f;
    // create_joint(anim_instance, &joint_data);
    return 0;
}