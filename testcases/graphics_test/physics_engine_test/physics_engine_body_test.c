...
int anim_physics_body_test(int argc, char *argv[])
{
    ...
    {
        /*调用anim_create_body_polygon创建小于8个顶点的刚体，5边形*/
    ...
    {
        /*调用anim_create_body_polygon创建大于8个顶点的刚体，正17边形*/
    ...
    {
        /*调用anim_create_body_polygon创建等于8个顶点的刚体，正8边形*/
    ...
    {
        /*调用anim_create_body_edge_polygon创建大于8条边的刚体，正17边形*/
    ...
    {
        /*调用anim_create_body_box创建一个矩形刚体*/
