...
int anim_physics_body_test(int argc, char *argv[])
{
    /*Initializelvgl*/
    ...
    {
        /*Create empty rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, create_null_rigid_body, 45, 3.0, linear_v_circle);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "1") == 0)
    {
        /*Create Circle rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, create_circle_rigid_body, 45, 3.0, linear_v_circle);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "2") == 0)
    {
        /*Call anim_create_body_polygon to create rigid body with less than 8 vertices, 5 Edge shape*/
        init_lvgl_image(&icon_nodes[0], NULL, create_pentagram_rigid_body, 45, 3.0, linear_v_circle);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "3") == 0)
    {
        /*Call anim_create_body_polygon to create rigid body with more than 8 vertices, regular 17 Edge shape*/
        init_lvgl_image(&icon_nodes[0], NULL, create_rigid_body_polygon_17_sides, 45, 3.0, linear_v_circle);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "4") == 0)
    {
        /*Call anim_create_body_polygon to create rigid body with equal to 8 vertices, regular 8 Edge shape*/
        init_lvgl_image(&icon_nodes[0], NULL, create_rigid_body_polygon_8_sides, 45, 3.0, linear_v_circle);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "5") == 0)
    {
        /*Call anim_create_body_edge_polygon to create rigid body with more than 8 edges, regular 17 Edge shape*/
        init_lvgl_image(&icon_nodes[0], NULL, create_rigid_body_edge_polygon_17_sides, 45, 3.0, linear_v);
    }

    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "6") == 0)
    {
        /*Call anim_create_body_box to create a Rectangle rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, create_box_rigid_body, 45, 3.0, linear_v_circle);
    }

    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "7") == 0)
    {
        /*Destroy rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, destory_circle_box_body, 45, 3.0, linear_v);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "8") == 0)
    {
        /*Create rigid body, Add shape and Delete*/
        init_lvgl_image(&icon_nodes[0], NULL, destory_shape, 45, 3.0, linear_v);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "9") == 0)
    {
        /*Create Dynamic rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, create_dynamic_rigid_body, 45, 3.0, linear_v);
    }
    if (strcmp(argv[2], "all") == 0 || strcmp(argv[2], "10") == 0)
    {
        /*Create kinematic rigid body*/
        init_lvgl_image(&icon_nodes[0], NULL, create_kinematic_rigid_body, 45, 3.0, linear_v);
    }
